...
class Union(click.ParamType):
    ...
    def convert(self, value: str, param: Optional[click.Parameter], ctx: Optional[click.Context]) -> Any:
        ...
        self.fail("All possible options exhausted without any successful conversion:\n - ")


option_type = Union([click.FLOAT, click.STRING])
...
@click.option("--teff", type=option_type, default="all")
@click.option("--logg", type=option_type, default=0.0)
@click.option("--feh", type=option_type, default=0.0)
@click.option("--alpha", type=option_type, default=0.0)
